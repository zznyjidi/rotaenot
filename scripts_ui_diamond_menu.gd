...
func _create_background_effects():
	...
	var effects_script = load("scripts_ui_menu_background_effects.gd")
...
func _create_audio_visualizer():
	...
	var visualizer_script = load("scripts_ui_diamond_audio_visualizer.gd")
...
func _on_start():
	...
	if music_player:
		music_player.stop()
	get_tree().change_scene_to_file("res://scenes_ui_song_select.tscn")
...
func _on_settings():
	...
	if music_player:
		music_player.stop()
	get_tree().change_scene_to_file("res://scenes_ui_settings_menu.tscn")
