	...
	if GameData and GameData.selected_song:
		...
		if GameData.selected_song.has("music_path"):
			...
			if stream:
				...
				print("Failed to load music from preloader")
...
func _game_over():
	...
	get_tree().change_scene_to_file("scenes_ui_results_screen.tscn")
...
func _on_quit_pressed():
	...
	get_tree().change_scene_to_file("scenes_ui_song_select.tscn")
