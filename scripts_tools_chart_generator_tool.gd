...
func _on_save_pressed():
	...
	var output_path = "charts/" + audio_name + "_generated.json"
...
func _on_test_pressed():
	...
	var temp_path = "charts/temp_test_chart.json"
	...
	# Load gameplay scene
	get_tree().change_scene_to_file("scenes_gameplay_gameplay_3d.tscn")
