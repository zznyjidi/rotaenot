...
/** @type {string} */
const CACHE_VERSION = '1759091149|2057147';
/** @type {string} */
const CACHE_PREFIX = 'rotaenot-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'rotaenot.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["rotaenot.html","rotaenot.js","rotaenot.offline.html","rotaenot.icon.png","rotaenot.apple-touch-icon.png","rotaenot.audio.worklet.js","rotaenot.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["rotaenot.wasm","rotaenot.pck"];
