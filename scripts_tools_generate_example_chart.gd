...
func _ready():
	...
	var music_path = "assets_music_Tobu - Faster [NCS Release].mp3"
	var output_dir = "charts/"
	...
	var electronic_music = "assets_music_Electro-Light, Kovan - Skyline Pt. II [NCS Release].mp3"
